...
var _user$project$Server$Broadcast = function (a) {
	return {ctor: 'Broadcast', _0: a};
};
var _user$project$Server$subs = function (model) {
...
var _user$project$Server$main = _elm_lang$core$Platform$program(
	{init: _user$project$Server$init, update: _user$project$Server$update, subscriptions: _user$project$Server$subs})();

var Elm = {};
Elm['Server'] = Elm['Server'] || {};
if (typeof _user$project$Server$main !== 'undefined') {
    _user$project$Server$main(Elm['Server'], 'Server', undefined);
}
