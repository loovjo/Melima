...
var _loovjo$traffic$Base$dist = function (pos) {
	return _elm_lang$core$Basics$sqrt((pos.x * pos.x) + (pos.y * pos.y));
};
var _loovjo$traffic$Base$toList = function (hmm) {
	var _p0 = hmm;
	if (_p0.ctor === 'Just') {
		return {
			ctor: '::',
...
var _loovjo$traffic$Base$level1Health = 20;
var _loovjo$traffic$Base_ops = _loovjo$traffic$Base_ops || {};
_loovjo$traffic$Base_ops['!!'] = F2(
	function (lst, idx) {
		return _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, idx, lst));
	});
var _loovjo$traffic$Base$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _loovjo$traffic$Base$GameState = F2(
	function (a, b) {
		return {players: a, entities: b};
	});
var _loovjo$traffic$Base$Player = F8(
	function (a, b, c, d, e, f, g, h) {
		return {pos: a, rotation: b, turning: c, vel: d, name: e, id: f, health: g, maxHealth: h};
	});
var _loovjo$traffic$Base$You = F2(
	function (a, b) {
		return {ip: a, id: b};
	});
var _loovjo$traffic$Base$TotalState = F2(
	function (a, b) {
		return {state: a, you: b};
	});
var _loovjo$traffic$Base$ZapEntity = F4(
	function (a, b, c, d) {
		return {ctor: 'ZapEntity', _0: a, _1: b, _2: c, _3: d};
	});

var _loovjo$traffic$ClientBase$keyboardMap = {
	ctor: '::',
	_0: '',
	_1: {
		ctor: '::',
																																																																																																																																																...
																																																																																																																																																_1: {
																																																																																																																																																	...
																																																																																																																																																	_1: {
																																																																																																																																																		...
																																																																																																																																																		_1: {
																																																																																																																																																			...
																																																																																																																																																			_1: {
																																																																																																																																																				ctor: '::',
																																																																																																																																																				_0: 'WIN_OEM_FJ_MASSHOU',
																																																																																																																																																				_1: {
																																																																																																																																																					ctor: '::',
																																																																																																																																																					_0: 'WIN_OEM_FJ_TOUROKU',
																																																																																																																																																					_1: {
																																																																																																																																																						ctor: '::',
																																																																																																																																																						_0: 'WIN_OEM_FJ_LOYA',
																																																																																																																																																						_1: {
																																																																																																																																																																											...
																																																																																																																																																																											_1: {
																																																																																																																																																																												...
																																																																																																																																																																												_1: {
																																																																																																																																																																													...
																																																																																																																																																																													_1: {
																																																																																																																																																																														...
																																																																																																																																																																														_1: {
																																																																																																																																																																															ctor: '::',
																																																																																																																																																																															_0: 'OPEN_CURLY_BRACKET',
																																																																																																																																																																															_1: {
																																																																																																																																																																																ctor: '::',
																																																																																																																																																																																_0: 'CLOSE_CURLY_BRACKET',
																																																																																																																																																																																_1: {
																																																																																																																																																																																	ctor: '::',
																																																																																																																																																																																	_0: 'TILDE',
																																																																																																																																																																																	_1: {
...
var _loovjo$traffic$ClientBase$toPixels = F2(
	function (model, unit) {
		return {x: (unit.x + model.scroll.x) * model.zoom, y: (unit.y + model.scroll.y) * model.zoom};
	});
var _loovjo$traffic$ClientBase$fromPixels = F2(
	function (model, pixel) {
		return {x: (pixel.x / model.zoom) - model.scroll.x, y: (pixel.y / model.zoom) - model.scroll.y};
	});
var _loovjo$traffic$ClientBase$decodeMouse = F2(
	function (model, pos) {
		return A2(
			_loovjo$traffic$ClientBase$fromPixels,
			model,
			A2(
				_loovjo$traffic$Base$Position,
										...
										return function (k) {
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return {gameState: a, you: b, lastTime: c, size: d, showDebug: e, err: f, webSocketUrl: g, scroll: h, scrollCenter: i, zoom: j, sideScroll: k, scrollSpeed: l, keysDown: m, lastMousePos: n, pressing: o};
														};
													};
												};
											};
...
var _loovjo$traffic$ClientBase$SendMsg = function (a) {
	return {ctor: 'SendMsg', _0: a};
};
var _loovjo$traffic$ClientBase$wsSend = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		_loovjo$traffic$ClientBase$SendMsg,
		_elm_lang$core$Task$succeed(msg));
};
var _loovjo$traffic$ClientBase$ServerMsg = function (a) {
	return {ctor: 'ServerMsg', _0: a};
};
var _loovjo$traffic$ClientBase$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _loovjo$traffic$ClientBase$SizeChanged = function (a) {
...
var _loovjo$traffic$ClientBase$MouseUp = function (a) {
	return {ctor: 'MouseUp', _0: a};
};
var _loovjo$traffic$ClientBase$MouseDown = function (a) {
	return {ctor: 'MouseDown', _0: a};
};
var _loovjo$traffic$ClientBase$KeyPress = function (a) {
	return {ctor: 'KeyPress', _0: a};
};
var _loovjo$traffic$ClientBase$KeyUp = function (a) {
	return {ctor: 'KeyUp', _0: a};
};
var _loovjo$traffic$ClientBase$KeyUp_ = function (a) {
	return {ctor: 'KeyUp_', _0: a};
};
var _loovjo$traffic$ClientBase$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _loovjo$traffic$ClientBase$KeyDown_ = function (a) {
	return {ctor: 'KeyDown_', _0: a};
};

var _loovjo$traffic$GameLogic$checkDeath = F2(
...
var _loovjo$traffic$GameLogic$checkPlayerCollisions = F2(
	function (delta, gameState) {
			...
			function (player1) {
				return A2(
					...
					function (player2) {
						...
						return ((_elm_lang$core$Native_Utils.cmp(
							_loovjo$traffic$Base$dist(pDelta),
					...
					function (player) {
						var intersectionsPoses = A2(
							...
							function (_p0) {
								...
								if (_elm_lang$core$Native_Utils.eq(_p2, player)) {
									...
									return _elm_lang$core$Maybe$Just(
										{
											x: delta.x * (_loovjo$traffic$Base$dist(delta) - 2),
											y: delta.y * (_loovjo$traffic$Base$dist(delta) - 2)
										});
								} else {
									return _elm_lang$core$Maybe$Nothing;
								}
						...
						return _elm_lang$core$Native_Utils.update(
							player,
							{
								...
								health: player.health - ((_loovjo$traffic$Base$dist(
									{
										x: sum(
											function (_) {
												return _.x;
...
var _loovjo$traffic$GameLogic$entityStep = F2(
	function (delta, entity) {
		...
		if (_elm_lang$core$Native_Utils.cmp(_p6, 0) < 0) {
			...
			return _elm_lang$core$Maybe$Just(
				A4(
					_loovjo$traffic$Base$ZapEntity,
...
var _loovjo$traffic$GameLogic$stepEntities = F2(
	function (delta, gameState) {
		return _elm_lang$core$Native_Utils.update(
			gameState,
			{
				entities: A2(
					_elm_lang$core$List$filterMap,
					_loovjo$traffic$GameLogic$entityStep(delta),
					gameState.entities)
			});
	});
var _loovjo$traffic$GameLogic$playerStep = F2(
...
var _loovjo$traffic$GameLogic$stepPlayers = F2(
	function (delta, gameState) {
		return _elm_lang$core$Native_Utils.update(
			gameState,
			{
				players: A2(
					_elm_lang$core$List$map,
					_loovjo$traffic$GameLogic$playerStep(delta),
					gameState.players)
			});
	});
var _loovjo$traffic$GameLogic$gameStep = F2(
	function (delta, gameState) {
		return A2(
			_loovjo$traffic$GameLogic$checkDeath,
			delta,
			A2(
				_loovjo$traffic$GameLogic$checkPlayerCollisions,
				delta,
				A2(
					_loovjo$traffic$GameLogic$stepEntities,
					delta,
					A2(_loovjo$traffic$GameLogic$stepPlayers, delta, gameState))));
	});

var _loovjo$traffic$JsonDecode$decodeYou = A3(
	...
	A3(
		...
		'ip',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Base$You)));
var _loovjo$traffic$JsonDecode$decodePosition = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'y',
	...
	A3(
		...
		'x',
		_elm_lang$core$Json_Decode$float,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Base$Position)));
var _loovjo$traffic$JsonDecode$decodePlayer = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'maxHealth',
	_elm_lang$core$Json_Decode$float,
	A3(
					...
					A3(
						...
						A3(
							...
							A3(
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
								'pos',
								_loovjo$traffic$JsonDecode$decodePosition,
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Base$Player)))))))));
var _loovjo$traffic$JsonDecode$decodeEntity = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'pos',
						_loovjo$traffic$JsonDecode$decodePosition,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Base$ZapEntity))))),
		_1: {ctor: '[]'}
	});
var _loovjo$traffic$JsonDecode$decodeGameState = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'entities',
	_elm_lang$core$Json_Decode$list(_loovjo$traffic$JsonDecode$decodeEntity),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'players',
		_elm_lang$core$Json_Decode$list(_loovjo$traffic$JsonDecode$decodePlayer),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Base$GameState)));
var _loovjo$traffic$JsonDecode$decodeTotalState = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'you',
	_loovjo$traffic$JsonDecode$decodeYou,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'gameState',
		_loovjo$traffic$JsonDecode$decodeGameState,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_loovjo$traffic$Base$TotalState)));

var _loovjo$traffic$MsgHandler$Zap = function (a) {
	return {ctor: 'Zap', _0: a};
};
var _loovjo$traffic$MsgHandler$Walk = function (a) {
			...
			_1: {
				...
				_0: {
					...
					_1: function (_p3) {
						return A2(
							_elm_lang$core$Maybe$map,
							_loovjo$traffic$MsgHandler$Zap,
							_elm_lang$core$Result$toMaybe(
...
var _loovjo$traffic$MsgHandler$parseTokens = function (_p4) {
	var _p5 = _p4;
	return _elm_lang$core$List$head(
		A2(
			_elm_lang$core$List$filterMap,
...
var _loovjo$traffic$MsgHandler$handleMsg = F2(
	function (_p9, state) {
		var _p10 = _p9;
		var _p18 = _p10._0;
		var pmsg = _loovjo$traffic$MsgHandler$parse(_p10._1);
		var _p11 = pmsg;
						...
						state,
						{
							players: {
								...
								_0: {
									...
									name: _p13,
									id: _p18,
									health: _loovjo$traffic$Base$level1Health,
									maxHealth: _loovjo$traffic$Base$level1Health
								},
								_1: state.players
							}
						}) : state;
					...
					if (_p14.ctor === 'Just') {
						...
						return _elm_lang$core$Native_Utils.update(
							state,
							{
								entities: {
									ctor: '::',
									_0: A4(_loovjo$traffic$Base$ZapEntity, _p15.pos, _p15.rotation, _p12._0, 0.3),
									_1: state.entities
								}
							});
					} else {
...
var _loovjo$traffic$Update_Keyboard$keyUp = F2(
	function (model, button) {
		return _elm_lang$core$Native_Utils.eq(button, 'SHIFT') ? A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_elm_lang$core$Native_Utils.update(
				model,
				{scrollCenter: _elm_lang$core$Maybe$Nothing}),
			{ctor: '[]'}) : ((_elm_lang$core$Native_Utils.eq(button, 'A') || _elm_lang$core$Native_Utils.eq(button, 'D')) ? A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			model,
			{
				ctor: '::',
				_0: _loovjo$traffic$ClientBase$wsSend('rot 0'),
				_1: {ctor: '[]'}
			}) : ((_elm_lang$core$Native_Utils.eq(button, 'W') || _elm_lang$core$Native_Utils.eq(button, 'S')) ? A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			model,
			{
				ctor: '::',
				_0: _loovjo$traffic$ClientBase$wsSend('walk 0'),
				_1: {ctor: '[]'}
			}) : A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			model,
...
var _loovjo$traffic$Update_Keyboard$keyDown = F2(
	function (model, button) {
		if (_elm_lang$core$Native_Utils.eq(button, 'SHIFT')) {
			var _p0 = model.lastMousePos;
			if (_p0.ctor === 'Just') {
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							scrollCenter: _elm_lang$core$Maybe$Just(
								A2(_loovjo$traffic$ClientBase$toPixels, model, _p0._0))
						}),
					{ctor: '[]'});
			} else {
				return A2(
			...
			if (_elm_lang$core$Native_Utils.eq(button, 'A')) {
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					model,
					{
						ctor: '::',
						_0: _loovjo$traffic$ClientBase$wsSend('rot -6'),
						_1: {ctor: '[]'}
					});
			} else {
				if (_elm_lang$core$Native_Utils.eq(button, 'D')) {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{
					...
					if (_elm_lang$core$Native_Utils.eq(button, 'W')) {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model,
							{
								ctor: '::',
								_0: _loovjo$traffic$ClientBase$wsSend('walk 10'),
								_1: {ctor: '[]'}
							});
					} else {
						if (_elm_lang$core$Native_Utils.eq(button, 'S')) {
							return A2(
								_elm_lang$core$Platform_Cmd_ops['!'],
								model,
								{
									ctor: '::',
									_0: _loovjo$traffic$ClientBase$wsSend('walk -7'),
									_1: {ctor: '[]'}
								});
						} else {
							if (_elm_lang$core$Native_Utils.eq(button, 'I')) {
								return A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
									_elm_lang$core$Native_Utils.update(
										model,
								...
								if (_elm_lang$core$Native_Utils.eq(button, 'O')) {
									return A2(
										_elm_lang$core$Platform_Cmd_ops['!'],
										_elm_lang$core$Native_Utils.update(
											model,
									...
									if (_elm_lang$core$Native_Utils.eq(button, '0')) {
										...
										if (_elm_lang$core$Native_Utils.eq(button, 'Z')) {
											return A2(
												...
												{
													ctor: '::',
													_0: _loovjo$traffic$ClientBase$wsSend('zap 30'),
													_1: {ctor: '[]'}
												});
										} else {
											return A2(
...
var _loovjo$traffic$Update_Mouse$mouseMoved = F2(
	function (model, pos) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			model,
...
var _loovjo$traffic$Update_Mouse$mouseUp = F2(
	function (model, pos) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			model,
...
var _loovjo$traffic$Update_Mouse$mouseDown = F2(
	function (model, pos) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			model,
...
var _loovjo$traffic$Update_Update$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p0 = msg;
			switch (_p0.ctor) {
				case 'KeyDown_':
					var _p1 = A2(_loovjo$traffic$Base_ops['!!'], _loovjo$traffic$ClientBase$keyboardMap, _p0._0);
					if (_p1.ctor === 'Just') {
						var _v2 = _loovjo$traffic$ClientBase$KeyDown(_p1._0),
							_v3 = model;
						msg = _v2;
						model = _v3;
						continue update;
				...
				case 'KeyUp_':
					var _p2 = A2(_loovjo$traffic$Base_ops['!!'], _loovjo$traffic$ClientBase$keyboardMap, _p0._0);
					if (_p2.ctor === 'Just') {
						var _v5 = _loovjo$traffic$ClientBase$KeyUp(_p2._0),
							_v6 = model;
						msg = _v5;
						model = _v6;
						continue update;
				...
				case 'KeyDown':
					var _p3 = _p0._0;
					return (!A2(_elm_lang$core$List$member, _p3, model.keysDown)) ? A2(
						_loovjo$traffic$Update_Keyboard$keyDown,
						_elm_lang$core$Native_Utils.update(
							model,
							{
								keysDown: {ctor: '::', _0: _p3, _1: model.keysDown}
							}),
						_p3) : A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
				...
				case 'KeyUp':
					var _p4 = _p0._0;
					return A2(
						_loovjo$traffic$Update_Keyboard$keyUp,
						_elm_lang$core$Native_Utils.update(
							model,
							{
								keysDown: A2(
						...
						_p4);
				case 'KeyPress':
					var chr = _elm_lang$core$Char$fromCode(_p0._0);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						model,
						{ctor: '[]'});
				case 'MouseDown':
					var _p5 = _p0._0;
					return A2(
						_loovjo$traffic$Update_Mouse$mouseDown,
						_elm_lang$core$Native_Utils.update(
							model,
							{
								lastMousePos: _elm_lang$core$Maybe$Just(
									A2(_loovjo$traffic$ClientBase$decodeMouse, model, _p5)),
								pressing: true
							}),
						A2(_loovjo$traffic$ClientBase$decodeMouse, model, _p5));
				case 'MouseUp':
					var _p6 = A2(
						_loovjo$traffic$Update_Mouse$mouseDown,
						model,
						A2(_loovjo$traffic$ClientBase$decodeMouse, model, _p0._0));
					var result = _p6._0;
					var cmd = _p6._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							result,
							{lastMousePos: _elm_lang$core$Maybe$Nothing, pressing: false}),
						_1: cmd
					};
				case 'MouseMoved':
					var _p8 = _p0._0;
					var _p7 = A2(
						_loovjo$traffic$Update_Mouse$mouseMoved,
						model,
						A2(_loovjo$traffic$ClientBase$decodeMouse, model, _p8));
					var result = _p7._0;
					var cmd = _p7._1;
					return {
						ctor: '_Tuple2',
				...
				case 'WsMsg':
					var _p9 = A2(_elm_lang$core$Json_Decode$decodeString, _loovjo$traffic$JsonDecode$decodeTotalState, _p0._0);
					if (_p9.ctor === 'Ok') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									gameState: _p9._0.state,
									you: _elm_lang$core$Maybe$Just(_p9._0.you),
				...
				case 'SizeChanged':
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								size: _elm_lang$core$Maybe$Just(
									A2(
										_loovjo$traffic$Base$Position,
										_elm_lang$core$Basics$toFloat(_p10.width),
										_elm_lang$core$Basics$toFloat(_p10.height)))
							}),
						{ctor: '[]'});
				case 'Tick':
					var time = _elm_lang$core$Time$inSeconds(_p0._0);
					var model_ = _elm_lang$core$Native_Utils.update(
						model,
						{
							lastTime: _elm_lang$core$Maybe$Just(time)
						});
					var _p11 = model.lastTime;
					if (_p11.ctor === 'Nothing') {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							model_,
						...
						var delta = time - _p11._0;
						var _p12 = function () {
							var _p13 = {ctor: '_Tuple2', _0: model.lastMousePos, _1: model.scrollCenter};
							if (((_p13.ctor === '_Tuple2') && (_p13._0.ctor === 'Just')) && (_p13._1.ctor === 'Just')) {
								var _p14 = _p13._1._0;
								var mouse = A2(_loovjo$traffic$ClientBase$toPixels, model, _p13._0._0);
								var diff = A2(_loovjo$traffic$Base$Position, mouse.x - _p14.x, mouse.y - _p14.y);
								var mult = _elm_lang$core$Basics$sqrt(
									_loovjo$traffic$Base$dist(diff));
								return {ctor: '_Tuple2', _0: (diff.x * delta) * mult, _1: (diff.y * delta) * mult};
							} else {
						...
						var sDx = _p12._0;
						var sDy = _p12._1;
						var modelScroll = _elm_lang$core$Native_Utils.update(
							model_,
							{
								scroll: {x: model.scroll.x + sDx, y: model.scroll.y + sDy}
							});
						var newMouse = function () {
							var _p15 = model.lastMousePos;
							if (_p15.ctor === 'Just') {
								return _elm_lang$core$Maybe$Just(
									A2(
										_loovjo$traffic$ClientBase$fromPixels,
										modelScroll,
										A2(_loovjo$traffic$ClientBase$toPixels, model, _p15._0)));
							} else {
								return _elm_lang$core$Maybe$Nothing;
							}
						}();
							...
							_elm_lang$core$Native_Utils.update(
								modelScroll,
								{
									...
									scrollCenter: function () {
										var _p16 = {ctor: '_Tuple2', _0: model.scrollCenter, _1: model.lastMousePos};
										if (((_p16.ctor === '_Tuple2') && (_p16._0.ctor === 'Just')) && (_p16._1.ctor === 'Just')) {
											return _elm_lang$core$Maybe$Just(
												A2(_loovjo$traffic$ClientBase$toPixels, model, _p16._1._0));
										} else {
											return _elm_lang$core$Maybe$Nothing;
										}
									}(),
									gameState: A2(_loovjo$traffic$GameLogic$gameStep, delta, model.gameState)
								}),
							{ctor: '[]'});
					}
				case 'ServerMsg':
					var _p17 = A2(_elm_lang$core$Json_Decode$decodeString, _loovjo$traffic$JsonDecode$decodeTotalState, _p0._0);
					if (_p17.ctor === 'Ok') {
						var _p18 = _p17._0;
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								model,
								{
									gameState: _p18.state,
									you: _elm_lang$core$Maybe$Just(_p18.you)
								}),
							{ctor: '[]'});
					} else {
						return A2(
				...
				default:
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							...
							{
								gameState: function () {
									var _p19 = A2(_elm_lang$core$Debug$log, 'you', model.you);
									if (_p19.ctor === 'Just') {
										return A2(
											_loovjo$traffic$MsgHandler$handleMsg,
											{ctor: '_Tuple2', _0: _p19._0.id, _1: _p20},
											model.gameState);
									} else {
						...
						{
							ctor: '::',
							_0: A2(_elm_lang$websocket$WebSocket$send, model.webSocketUrl, _p20),
							_1: {ctor: '[]'}
						});
			}
		}
...
var _loovjo$traffic$Render_Render$renderEntity = F2(
	function (model, entity) {
		...
		var _p1 = {
			...
			_0: function (_) {
				...
				A2(_loovjo$traffic$ClientBase$toPixels, model, _p3)),
			_1: function (_) {
				return _.y;
			}(
				A2(_loovjo$traffic$ClientBase$toPixels, model, _p3))
		...
		var x = _p1._0;
		var y = _p1._1;
		var _p2 = _elm_lang$core$Basics$fromPolar(
			{ctor: '_Tuple2', _0: model.zoom, _1: _p0._1});
		var dx = _p2._0;
		var dy = _p2._1;
		return {
			ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$svg$Svg_Attributes$x2(
								_elm_lang$core$Basics$toString(x + dx)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$y2(
									_elm_lang$core$Basics$toString(y + dy)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$strokeWidth('3'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$stroke('#00FFFF'),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _loovjo$traffic$Render_Render$renderPlayer = F2(
	function (model, player) {
		var _p4 = {
			...
			_0: function (_) {
				...
				A2(_loovjo$traffic$ClientBase$toPixels, model, player.pos)),
			_1: function (_) {
				return _.y;
			}(
				A2(_loovjo$traffic$ClientBase$toPixels, model, player.pos))
							...
							_1: {
								...
								_0: _elm_lang$svg$Svg_Attributes$fill(
									function () {
										var _p5 = model.you;
										if (_p5.ctor === 'Just') {
											return _elm_lang$core$Native_Utils.eq(_p5._0.id, player.id) ? 'blue' : 'red';
										} else {
											return '#1d54ad';
										}
									}()),
			...
			_1: {
				...
				_0: A2(
					_elm_lang$svg$Svg$line,
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$x1(
							_elm_lang$core$Basics$toString((cx - (5 * model.zoom)) - 2)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$y1(
								_elm_lang$core$Basics$toString(cy - (2 * model.zoom))),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$x2(
									_elm_lang$core$Basics$toString((cx + (5 * model.zoom)) + 2)),
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$strokeWidth('7'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$stroke('#000000'),
											_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						_elm_lang$svg$Svg$line,
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$x1(
								_elm_lang$core$Basics$toString(cx - (5 * model.zoom))),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$y1(
									_elm_lang$core$Basics$toString(cy - (2 * model.zoom))),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$x2(
										_elm_lang$core$Basics$toString((cx - (5 * model.zoom)) + (((model.zoom * 10) * player.health) / player.maxHealth))),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$y2(
											_elm_lang$core$Basics$toString(cy - (2 * model.zoom))),
					...
					_1: {
						...
						_0: A2(
							_elm_lang$svg$Svg$line,
							function () {
								var _p6 = _elm_lang$core$Basics$fromPolar(
								...
								return {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$x2(
												_elm_lang$core$Basics$toString(dx + cx)),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$y2(
													_elm_lang$core$Basics$toString(dy + cy)),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$strokeWidth('3'),
													_1: {
						...
						_1: {
							...
							_0: A2(
								_elm_lang$svg$Svg$text_,
								{
									...
									_1: {
										...
										_0: _elm_lang$svg$Svg_Attributes$y(
											_elm_lang$core$Basics$toString((model.zoom * 2.5) + cy)),
										_1: {
											ctor: '::',
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg$text(player.name),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_0: A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$List$concatMap,
								_loovjo$traffic$Render_Render$renderEntity(model),
									...
									return _elm_lang$core$Native_Utils.eq(
										...
										_0: A2(
											_elm_lang$svg$Svg$circle,
											{
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$cx(
													_elm_lang$core$Basics$toString(_p10.x - 50)),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$cy(
														_elm_lang$core$Basics$toString(_p10.y - 50)),
													_1: {
														ctor: '::',
...
var _loovjo$traffic$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$downs(_loovjo$traffic$ClientBase$KeyDown_),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$ups(_loovjo$traffic$ClientBase$KeyUp_),
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$presses(_loovjo$traffic$ClientBase$KeyPress),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$websocket$WebSocket$listen, model.webSocketUrl, _loovjo$traffic$ClientBase$WsMsg),
						_1: {
							ctor: '::',
							_0: _elm_lang$window$Window$resizes(_loovjo$traffic$ClientBase$SizeChanged),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second / _loovjo$traffic$ClientBase$fps, _loovjo$traffic$ClientBase$Tick),
								_1: {
									ctor: '::',
									_0: _elm_lang$mouse$Mouse$downs(_loovjo$traffic$ClientBase$MouseDown),
									_1: {
										ctor: '::',
										_0: _elm_lang$mouse$Mouse$ups(_loovjo$traffic$ClientBase$MouseUp),
										_1: {
											ctor: '::',
											_0: _elm_lang$mouse$Mouse$moves(_loovjo$traffic$ClientBase$MouseMoved),
											_1: {
												ctor: '::',
...
var _loovjo$traffic$Main$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {
			gameState: A2(
				_loovjo$traffic$Base$GameState,
				{ctor: '[]'},
				{ctor: '[]'}),
			you: _elm_lang$core$Maybe$Nothing,
			...
			scrollSpeed: 100,
			keysDown: {ctor: '[]'},
			lastMousePos: _elm_lang$core$Maybe$Nothing,
			pressing: false
		},
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Task$perform, _loovjo$traffic$ClientBase$SizeChanged, _elm_lang$window$Window$size),
				_1: {ctor: '[]'}
			})
	};
};
var _loovjo$traffic$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _loovjo$traffic$Main$init, view: _loovjo$traffic$Render_Render$view, update: _loovjo$traffic$Update_Update$update, subscriptions: _loovjo$traffic$Main$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _loovjo$traffic$Main$main !== 'undefined') {
    _loovjo$traffic$Main$main(Elm['Main'], 'Main', undefined);
}
